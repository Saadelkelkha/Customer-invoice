...
y=int(input("Give the number of items for the customer n1 :"))
s1=0
for i in range (1,y+1):
        print("Give the price of the item n'",i,":")
        p = float(input())
        s1=s1+p
n2=str(input("Give the first ana last name of customer n2 :"))
y=int(input("Give the number of items for the customer n2 :"))
s2=0
for i in range (1,y+1):
        print("Give the price of the item n'",i,":")
        p = float(input())
...
y=int(input("Give the number of items for the customer n3 :"))
s3=0
for i in range (1,y+1):
        print("Give the price of the item n'",i,":")
        p = float(input())
